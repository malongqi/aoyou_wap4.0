        ...
        <view-box class="page-inner-detail">
            <section v-for="item in detailData" class="detail-item"><!--0410 F-->
                ...
                <div class="tit">
                    ...
                    <div class="brief" v-if="item.HotelInfo!=''"><i class="i-hotel"></i><p>{{item.HotelInfo}}</p></div>
                </div>
                <div class="content">
...
import { go } from '../../libs/router'
  ...
  export default {
    ...
    methods: {
        ...
        takeData:function(){
           //主信息
           this.detailData = p_mainData.JourneyList
        },

	    //跳转至相应锚点 /*0410 F*/
	    setAnchor:function(){
		    let _idx=window.localStorage.getItem('selectedStaticIndex')
