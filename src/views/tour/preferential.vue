<template>
    <div class="page-wrap">
        <div class="page choose page-preferential">
            <view-box v-if="!showPagechoose" v-ref:view-box>
                <headerbar class="shade" @on-click-title="scrollTop" slot="header">
                ...
                <div class="page-inner-preferential">
                    <div class="maincont">
                        <div v-for="item in preferentialData">
                            <section v-if="item.IsPrePlatform">
                                <h3>{{item.PreName}}</h3>
                                <div class="time">
                                    <p>优惠时间：</p>
                            ...
                            <div class="more" v-if='!item.IsPrePlatform'>
                                <h6>{{item.PreName}}</h6>
                                <p v-html="item.PreDescription|html"></p>
                            </div>
                        </div>
...
export default {
    ...
    methods: {
      ...
      takeData:function(){
         //优惠信息列表
         var tempthis = this
         var productParam={"ProductID":tempthis.selectedData.pid}
          api.post({
