                ...
                <div class="page-inner-room">
                        ...
                        <ul>
                            <li>
                                <div class="cont clearfix">
                                    <img :src='hotelData.HotelPicList!=undefind?hotelData.HotelPicList[0]:"http://pic1.aoyou.com/wap4.0/index/bg-s.png?imageView2/1/w/80/h/60"' v-link="{path:hotelData.HotelPicList!=undefind?'hotelimg':'',query:{index:stayIndex,hpid:hpid,hid:hid}}">
                    ...
                    <div class="roomcont">
                        <div class="room" v-for='item in hotelData.RoomPlanList' :class="{'active':selectedData.stayPlaces[stayIndex].hotel.roomPlan.PlanID==item.PlanID,'manyroom':item.RoomList.length>1}" >
                            ...
                            <div class="choose clearfix" v-if="false">
                    ...
                    <div class="popup3">
                        <group>
                            <div class="cont">
                                ...
                                <div class="pic">
                                    <!--<swiper :aspect-ratio="440/670" height="200px" v-ref:picWall>
    ...
    methods: {
      takeData:function(){
        ...
        if(g_hotel_list&&g_hotel_list.length>0)
        {
            ...
            if(stayPlace&&stayPlace.HotelPlanList&&stayPlace.HotelPlanList.length>0)
            {
                for(var i=0;i<stayPlace.HotelPlanList.length;i++)
                {
                    if(stayPlace.HotelPlanList[i].HotelPlanID==this.hpid)
                    {
                        ...
                        for(var j=0;j<hotelPlan.HotelList.length;j++)
                        {
                            ...
                            {
                                this.hotelData=hotelPlan.HotelList[j]
                            }
                        }
                    }
                }
