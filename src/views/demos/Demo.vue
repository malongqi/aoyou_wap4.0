<template>
  <div>
    <group title="Form" title-color="#E94709">
    ...
    <group title="Message && Tip" title-color="#E94709">
    ...
    <group title="UI" title-color="#E94709">
    ...
    <group title="Scroller" title-color="#E94709">
    ...
    <group title="Other" title-color="#E94709">
    ...
    <group title="CSS Utils" title-color="#E94709">
      <cell title="1px" value="1px解决方案" link="component/1px"></cell>
     ...
     <group title="Plugins" title-color="#E94709">
      <cell title="Device" value="简单设备信息检测" link="plugin/device"></cell>
    </group>

    <group title="TODO" title-color="#E94709" v-if="showTodo">
    ...
    <group title="Demo" title-color="#E94709">
      <cell title="微信设置页面" link="demo/wechat">
        <span class="demo-icon" slot="icon">&#xe600;</span>
      </cell>
      <cell title="遨游直播厅" link="demo/yi">
        <span class="demo-icon" slot="icon">&#xe622;</span>
      </cell>
    </group>
