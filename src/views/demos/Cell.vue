  ...
  <div>
    ...
    <group title="use slot for complexed content">
      <cell title="slot content">
        <div slot="value">
          <span style="color: green">Hi, I'm ay.</span>
        </div>
      </cell>
    </group>

    <group title="isLink is set to true when link exists">
      <cell title="Go to Radio" link="/flight/demo.html/component/radio" inline-desc='link="/component/radio"'></cell>
      <cell title="Go to Demo" :link="{path:'/module/demo.html'}" inline-desc=':link={path:"/demo"}'></cell>
      <cell title="http link" link="https://ay.li" inline-desc='link="https://ay.li"'></cell>
    </group>
  </div>
</template>
