  ...
  <div style="height:100%;">
    ...
    <view-box v-ref:view-box>
      ...
      <tabbar class="ay-demo-tabbar" icon-class="ay-center" v-show="!isTabbarDemo" slot="bottom">
        <tabbar-item v-link="{path:'/module/demo.html/'}" :selected="route.path === '/'">
          <span class="demo-icon-22 ay-demo-tabbar-icon-home" slot="icon">&#xe639;</span>
          <span slot="label">首页</span>
        </tabbar-item>
        <tabbar-item v-link="{path:'/module/demo.html/demo'}" :selected="isDemo" badge="9">
        ...
        <tabbar-item v-link="{path:'/module/demo.html/project/donate'}" :selected="route.path === '/project/donate'" show-dot>
          <span class="demo-icon-22" slot="icon">&#xe630;</span>
