...
import CoinIntros from '../../views/member/coin-intros'
import MyCoins from '../../views/member/my-coins'
import Privilege from '../../views/member/privilege'
